<nav x-data="{ open: false }">
    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex justify-end space-x-6 p-4 text-lg text-gray-500">
            @guest
                <a href="/register" class="flex items-center space-x-1 hover:text-green-600 underline">
                ...
                <a href="/login" class="flex items-center space-x-1 hover:text-green-600 underline">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                <div class="flex-shrink-0">
                    <svg class="h-10 w-10 fill-current text-green-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
